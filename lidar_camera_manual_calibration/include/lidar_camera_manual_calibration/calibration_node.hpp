...
private:
  ...
  std::shared_ptr<calibration_common::CloudSubscriber<pcl::PointXYZI>> pointcloud_sub_;
  ...
  bool exit_{false};
  // sensor data
  std::deque<calibration_common::CloudSubscriber<pcl::PointXYZI>::MsgData> pointcloud_msgs_;
