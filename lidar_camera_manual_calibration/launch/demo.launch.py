...
def generate_launch_description():
    ...
    pkg_lidar_camera_manual_calibration = get_package_share_directory(
        "lidar_camera_manual_calibration"
    )
    calibrator_config = os.path.join(
        pkg_lidar_camera_manual_calibration, "config", "calibrator.yaml"
    )
    initial_calibration = os.path.join(
        pkg_lidar_camera_manual_calibration, "config", "initial_calibration.yaml"
    )
